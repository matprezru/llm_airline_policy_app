"""
API Endpoints related to database operations: upload documents, list chunks, retrieve chunks...
...
async def retrieve_chunk(request: RetrieveChunkRequest):
    ...
    return RetrieveChunkResponse(page_content=chunk.get("page_content", ""), metadata=chunk.get("metadata", {}))
