...
class CustomEmbeddings:
    ...
    def _load_embedding_model(self, provider: str, model_name: str) -> Embeddings:
        ...
        logger.debug(f"Loading embedding model. Provider: {provider}. Model name: {model_name}")
        ...
        if provider == EmbeddingProvider.OPENAI:
            ...
            raise ValueError(f"Unsupported embedding provider: '{provider}'. Must be one of: {[e.value for e in EmbeddingProvider]}.")
