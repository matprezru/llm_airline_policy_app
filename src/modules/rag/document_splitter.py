    ...
    def split_documents(self) -> List[List[Document]]:
        ...
        for doc in self.documents:
            ...
            if ext == ".pdf":
                ...
                logger.warning(f"Could not split document '{doc[0].metadata.get('source')}'. Unsupported file type: '{ext}'")
        ...
        if not splitted_documents:
            raise Exception("The specified documents could not be splitted into chunks.")
        ...
        for doc in documents:
            ...
            for i, chunk in enumerate(splitted_doc):
                ...
                for header_symbol, header_name in reversed(self.headers_to_split_on):
                    ...
                    if header_content:
                        chunk.page_content = f"{header_symbol} {header_content}\n\n{chunk.page_content}"
